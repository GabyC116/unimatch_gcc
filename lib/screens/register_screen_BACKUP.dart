...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final List<String> _allInterests = [
    "Matemticas", "Fsica", "Qumica", "Programacin",
    "Bases de Datos", "Redes", "Inteligencia Artificial",
    "Ingls", "Francs", "Diseo Grfico", "Marketing",
    "Contabilidad", "Estadstica", "Investigacin"
  ];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: Text("O regstrate con", style: TextStyle(color: Colors.grey[600])),
                ),
                Expanded(child: Divider(color: Colors.grey[300])),
              ],
            ),
            ...
            _buildTextField("Correo electrnico", Icons.email, _emailController, TextInputType.emailAddress),
            const SizedBox(height: 15),
            _buildTextField("Contrasea", Icons.lock, _passwordController, null, true),
            const SizedBox(height: 15),
            _buildTextField("Confirmar contrasea", Icons.lock, _confirmPasswordController, null, true),
  ...
  // SECCIN DE FOTOS (3 mximo) - VERSIN CORREGIDA
  Widget _buildPhotosSection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 5),
        const Text(
          "Agrega hasta 3 fotos (la primera ser tu foto principal)",
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              // Botn para agregar (si hay menos de 3)
  ...
  void _showAddPhotoDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Cmo quieres agregar la foto?"),
        actions: [
          TextButton(
            onPressed: () {
          ...
          TextButton(
            ...
            child: const Text("Elegir de galera"),
          ),
          TextButton(
  ...
  void _addPhoto(String source) {
    if (_profilePhotos.length >= 3) {
      _showMessage("Mximo 3 fotos alcanzado");
      return;
    }
    ...
    _showMessage("Foto agregada desde $source (simulacin)");
  }
  ...
  void _registerWithGoogle() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Esta funcin simula autenticacin con Google"),
        actions: [
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              ...
              _selectedCareer = "Ingeniera de Sistemas";
              setState(() {;
